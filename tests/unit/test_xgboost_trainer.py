"""
Unit tests for XGBoost Trainer.

Tests XGBoost gradient boosting model training functionality.
"""
...
class TestXGBoostTrainer:
    """Test XGBoost trainer functionality."""
    ...
    def trainer(self, config):
        """Create XGBoost trainer instance."""
    ...
    def test_get_model_instance_invalid_type(self, trainer):
        ...
        with pytest.raises(TrainingError, match="Unknown XGBoost model type"):
    ...
    def test_train_binary_classification(self, trainer, binary_classification_data):
        ...
        model = trainer.get_model_instance("xgboost_binary_classification", {})
    ...
    def test_train_multiclass_classification(self, trainer, multiclass_classification_data):
        ...
        model = trainer.get_model_instance("xgboost_multiclass_classification", {})
        trained_model = trainer.train(model, X, y)
    ...
    def test_train_regression(self, trainer, regression_data):
        ...
        model = trainer.get_model_instance("xgboost_regression", {})
        trained_model = trainer.train(model, X, y)
    ...
    def test_feature_importance_extraction(self, trainer, binary_classification_data):
        ...
        summary = trainer.get_model_summary(trained_model, "xgboost_binary_classification", feature_names)
    ...
    def test_get_model_summary(self, trainer, regression_data):
        ...
        summary = trainer.get_model_summary(trained_model, "xgboost_regression", feature_names)

        assert summary["model_type"] == "xgboost_regression"
        assert summary["n_features"] == 3
        assert summary["feature_names"] == feature_names
        assert summary["framework"] == "xgboost"
    ...
    def test_hyperparameter_merging(self, trainer):
        ...
        model = trainer.get_model_instance(
            "xgboost_binary_classification",
            {
                "n_estimators": 200,
                "max_depth": 8,
                # subsample should use default (0.8)
            }
        )
        ...
        assert params["subsample"] == 0.8  # default

    # Test 8: Supported models
    def test_get_supported_models(self):
        """Test getting list of supported models."""
        supported = XGBoostTrainer.get_supported_models()

        assert "xgboost_binary_classification" in supported
        assert "xgboost_multiclass_classification" in supported
        assert "xgboost_regression" in supported
    ...
    def test_repr(self, trainer):
        ...
        assert "XGBoostTrainer" in repr_str
        assert "xgboost_binary_classification" in repr_str
    ...
    def test_all_model_types_end_to_end(self, trainer, binary_classification_data,
        ...
        model_bin = trainer.get_model_instance("xgboost_binary_classification", {})
        ...
        model_multi = trainer.get_model_instance("xgboost_multiclass_classification", {})
        ...
        model_reg = trainer.get_model_instance("xgboost_regression", {})
